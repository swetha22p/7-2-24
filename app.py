...
def update_medical_form(id):
    try:
        ...
        # existing_data = medical_forms.find_one({'id': ObjectId(id)})
        ...
        medical_forms.update_one({'id': int(id)}, {'$set': updated_data})
...
def get_medical_data_by_id(id):
    try:
        ...
        medical_data = mongo.db.medical_forms.find_one({'id': obj_id})
        ...
        if medical_data:
            ...
            medical_data_int = mongo.db.medical_forms.find_one({'id': int(id)})
...
def delete_medical_data(id):
    try:
        ...
        result = mongo.db.medical_forms.delete_one({'id': obj_id})
...
def update_medical_data(id):
    try:
        ...
        result = mongo.db.medical_forms.update_one({'id': obj_id}, {'$set': updated_data})
